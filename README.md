...
Section flags 0x42 (66) == SHF_ALLOC SHF_INFO_LINK 
...
Section type == 0x1 (1) SHT_PROGBITS
Section name == .init
Section flags 0x6 (6) == SHF_ALLOC SHF_EXECINSTR 
...
Section flags 0x3 (3) == SHF_WRITE SHF_ALLOC 
Section length == 0x8 (8)
